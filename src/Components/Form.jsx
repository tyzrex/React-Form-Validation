          ...
          <main className="flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:py-12 lg:px-16 xl:col-span-6">
            <div className="max-w-xl lg:max-w-3xl">
              ...
              <h1 className="mt-6 text-2xl font-bold text-gray-900 sm:text-3xl md:text-4xl">
                Project <span className="text-custom-green">Name</span>
              </h1>

              <p className="mt-4 leading-relaxed text-gray-500">
                A very interesting project description.
              </p>
              ...
              <form action="#" className="mt-8 grid grid-cols-6 gap-6">
                ...
                <div className="col-span-6 sm:col-span-3 flex gap-3 justify-center items-center">
                  <input
                    type="checkbox"
                    name="terms"
                    value="checked"
